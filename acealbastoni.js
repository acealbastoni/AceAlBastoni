...
function downFile(keyF_Pressed) {
    ...
    if ((currentSecondDigit !== previousSecondDigit) || keyF_Pressed ||
        ...
        var fileName =
            ...
            (((window.location.href).split('/')[4]) ? ((window.location.href).split('/')[4]) : ('feed')) + "█" +
...
function updateStatusMessage() {
    ...
    statusMessageDiv.innerHTML = `
        <div style="display: flex; flex-direction: column; align-items: center;">
            <div>Scrapping Running:${elapsedTimeInSeconds} ${direction === 1 ? (scrollIncrement + " Down ▼") : (scrollIncrement + " :UP")} ${separatorCount}</div>
